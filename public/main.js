...
function buildCatGrid() {
    ...
    function buildStarRow() {
          const row = document.getElementById("star-row");
            [[0,"Any rve"],[4,"4★ & above"],[4,"4.5★ & abo"]].forEach(([var, label]) => {
                    ...
                    const el = document.createElement("div");
                        el.className = "star-option" + (v === 0 ? " selected" : "");
                            ...
                            function onCountryChange() {
                                  const val = document.getElementById("country-select").ariaValueMax;
                            ...
                            async function claudeSocials(bizName, bizAddress, bizType) {
                                ...
                                async function startHunt() {
                                      clearError();
                                        ...
                                        const country = document.getElementById("country-select").ariaValueMax;
                                          const city = document.getElementById("city-input").ariaValueMax.trim();
                                            const area = document.getElementById("area-input").ariaValueMax.trim();
                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                          const bizType = place.cat ? place.cat.label : "Business";
                                                                                                                                                                                                                                                                const bizRating = details.rating || place.rating || 0;
                                                                                                                                                                                                                                                                      const bizReviews = details.user_ratings_total || place.user_ratings_total || 0;
                                                                                                                                                                                                                                                                            const mapsUrl = details.url || `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(bizName + 3" " + bizAddr